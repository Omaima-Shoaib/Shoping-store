...
<td >
    <td class="title mytitle"> <a style="text-decoration: none;color:white" href="{{ route('products.get',$product['id']) }}"> <div style="background-color: #112739;border-radius: 25px;width: 100px">view</div></a></td>
